...
class Flow(object):
    ...
    __slots__ = ['flowId', 'delayMean', 'packetLossRatio', 'rxBitrate', 'txBitrate',
                 ...
                 'hopCount', 'flowInterruptionsHistogram', 'rx_duration','lost','rxPackets','txPackets']
    def __init__(self, flow_el):
        ...
        if self.rxPackets == 0:
            ...
            self.packetLossRatio = (self.lost / (self.rxPackets + self.lost))
