...
{
  DpctlExecute (swtch, "flow-mod cmd=add,table=1,prio=1 in_port=1 write:output=2");
  DpctlExecute (swtch, "flow-mod cmd=add,table=1,prio=1 in_port=2 write:output=1");
}